...
class ImageOptimizationService {
  static const int _maxImageSize = 512; // Max width/height in pixels
  static const int _jpegQuality = 85; // JPEG compression quality (0-100)
  static const int _maxDataUrlLength = 50000; // Max data URL length in chars
  ...
  static String? optimizeDataUrl(String? dataUrl) {
    ...
    try {
      ...
      if (kDebugMode) {
        print('📸 Image optimization: ${dataUrl.length} -> ${optimizedUrl.length} chars '
